      ...
      <li class="client-item-frame">
        <Card class="client-item">
          ...
          <div v-else>
            ...
            <div class="bind-item">
              <Input v-model="newClient.phone" placeholder="Telegram账号 如：（63977***3224）">
                <Button slot="append" style="width: 100px" v-if="newClient.timer" :disabled="newClient.timer>0">倒计时{{newClient.timer}}s</Button>
            ...
            <div class="bind-item">
              <Button @click="newClient.binding=false">取消绑定</Button>
            </div>
          </div>
        </Card>
      </li>
